...
int withdraw() {
	...
	cin >> amount;
	while ((amount % 500 != 0 || amount > currentbalance||amount<0) && count <= 1) {
	...
	if (amount % 500 == 0 && amount < currentbalance && amount>=0) {
		d = 1;
		x = 1;
	...
	cout << "Your curreny balance is " << currentbalance;
	return 0;
